...
namespace API_VanityHairSalon.Controllers
{
    ...
    public class EmpleadosController : ControllerBase
    {
        ...
        public EmpleadosController(VanityHairSalonContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Empleado>>> GetEmpleados()
        {
          if (_context.Empleados == null)
          {
            ...
            var vempleados = await _context.Empleados.Include(x => x.IdEspecialidadNavigation).ToListAsync();
            return Ok(vempleados);
        }
        ...
        public async Task<ActionResult<Empleado>> PostEmpleado(Empleado empleado)
        {
          if (_context.Empleados == null)
          {
              return Problem("Entity set 'VanityHairSalonContext.Empleados'  is null.");
          }
